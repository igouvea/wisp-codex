...
let panelJSON = """
{
  ...
  "sessions": [
    {"st":"tool",    "dt":"Bash",         "pj":"wisp-codex","md":"opus-5",  "age":2},
    {"st":"asking",  "dt":"Auth method",  "pj":"storefront","md":"opus-5",  "age":14},
    {"st":"working", "dt":"thinking",     "pj":"api",       "md":"sonnet-5","age":5}
  ],
  "limits": [
    {"l":"Session 5h",   "p":41, "r":"3h", "s":"normal",  "a":true,  "x":false, "g":"claude", "age":48, "src":"live"},
    {"l":"Weekly",       "p":68, "r":"4d", "s":"warning", "a":false, "x":false, "g":"claude", "age":48, "src":"live"},
    {"l":"Weekly Opus",  "p":22, "r":"4d", "s":"normal",  "a":false, "x":false, "g":"claude", "age":48, "src":"live"},
    {"l":"Weekly",       "p":57, "r":"5d", "s":"normal",  "a":true,  "x":false, "g":"codex",  "age":12, "src":"local"}
  ],
  "limits_age_s": 48, "peak": 68,
  "usage": {"requests": 1841, "input": 92130, "output": 664200, "cache_read": 18400000},
  "usage_by_provider": {
    "claude": {"requests": 1512, "input": 92130, "output": 584200, "cache_read": 16400000},
    "codex":  {"requests": 329,  "input": 4400000, "output": 80000, "cache_read": 2000000}
  },
  "open_network": false,
  "windows": {
    "ok": true,
